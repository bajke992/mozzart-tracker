            ...
            $ls.forEach(function (item) {
                ...
                $table.append(
                        $('<tr/>').append(
                                ...
                                $('<td/>').text(item.odds[5].subgames[0].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[1].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[2].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[3].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[4].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[5].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[6].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[7].value)
                        ).append(
                                $('<td/>').text(item.odds[5].subgames[8].value)
                        )
                );
            });
        }
